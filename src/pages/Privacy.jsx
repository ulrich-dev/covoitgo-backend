...
const CONTENT = {
  fr: {
    ...
    sections: [
      { title: '1. Responsable du traitement', text: `Covoitgo SAS, société française, est responsable du traitement de vos données personnelles collectées via la Plateforme. Pour toute question relative à la protection de vos données, vous pouvez contacter notre Délégué à la Protection des Données (DPO) à l'adresse : dpo@covoitgo.fr.` },
      ...
      { title: '7. Vos droits (RGPD)', text: `Conformément au RGPD, vous disposez des droits suivants : droit d'accès, droit de rectification, droit à l'effacement ("droit à l'oubli"), droit à la limitation du traitement, droit à la portabilité, droit d'opposition. Pour exercer ces droits, contactez-nous à : privacy@covoitgo.fr. Vous pouvez également introduire une réclamation auprès de la CNIL.` },
  ...
  en: {
    ...
    sections: [
      { title: '1. Data Controller', text: `Covoitgo SAS, a French company, is the controller of your personal data collected through the Platform. For any questions regarding the protection of your data, you may contact our Data Protection Officer (DPO) at: dpo@covoitgo.fr.` },
        ...
        <div className="legal-wrap" style={{ maxWidth:800, margin:'0 auto', padding:'48px 28px 80px' }}>
          ...
          <div style={{ marginTop:32, background:'#F3EEFF', border:'1.5px solid rgba(124,58,237,0.2)', borderRadius:16, padding:'24px 28px', display:'flex', gap:16, alignItems:'flex-start' }}>
            ...
            <div>
              ...
              <a href="mailto:privacy@covoitgo.fr" style={{ color:'#7C3AED', fontWeight:700, fontSize:14, textDecoration:'none' }}>
                privacy@covoitgo.fr →
              </a>
            </div>
          </div>
